...
class CloudsTest {
    ...
    void testWorstOffers() {
        ...
        assertEquals(List.of(PayPeriod.ANNUAL, PayPeriod.MONTHLY, PayPeriod.MONTHLY), worstStorages.stream().map(CloudStorage::getPayPeriod).collect(Collectors.toList()));
    ...
    void testWorstOffersWithOneProvider() {
        ...
        assertEquals(List.of(PayPeriod.ANNUAL), worstStorages.stream().map(CloudStorage::getPayPeriod).collect(Collectors.toList()));
